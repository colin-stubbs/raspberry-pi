...
[+] Building 166.4s (9/9) FINISHED
 ...
 => [4/4] RUN echo "### Update GeoIP databases ( license key Wqf2WzRIg65LPOF5 )" &&   apt update && apt -y install wget &&   chmod 0755 /usr/bin/geoipupdate &&   /usr/bin/geoipupdate Wqf2WzRIg65LPOF5 &&   apt -y install git gnupg2 lsb-rele  131.8s
